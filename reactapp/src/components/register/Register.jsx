...
const Register = ({ changeUser }) => {
  ...
  const checkUsernameAvailability = () => {
    axios
      .get(`https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/customer/username/${userName}`)
      .then((response) => {
  ...
  const registerUser = (event) => {
    ...
    setRegisterFailed('');
    axios
      .post(`https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/${userType}/register`, {
        userName,
        password,
        phoneNumber,
        address,
