...
class OrderCard extends React.Component {
  ...
  orderInfo() {
    axios.get("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/restaurant/" + this.props.order.restaurantId).then(
      response => {
    ...
    axios.get("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/customer/" + this.props.order.customerId).then(
      response => {
    ...
    if (this.props.order.driverId) {
      axios.get("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/driver/" + this.props.order.driverId).then(
        response => {
  ...
  deleteOrder() {
    axios.delete("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/order/" + this.props.order.id).then(
      response => {
  ...
  acceptOrder() {
    axios.post("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/driver/accept", {
  ...
  finishOrder() {
    axios.post("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/driver/finish", {
      orderId : this.props.order.id
    }).then(
      response => {
        this.props.getOrders();
  ...
  deleteComment() {
    axios.delete("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/order/deleteComment/" + this.props.order.id).then(
      response => {
        this.props.getOrders();
      }
    ).catch(err => console.log(err));
  ...
  addComment() {
    axios.post("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/order/addComment", {
      orderId : this.props.order.id,
