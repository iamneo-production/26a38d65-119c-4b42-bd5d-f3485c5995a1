...
class DisplayRestaurant extends React.Component {
  ...
  getRestaurant() {
    axios.get("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/restaurant/" + this.state.restaurantId).then(
      response => {
  ...
  addToCart() {
    axios.post("https://8080-bbafabdbdfaeddbefbefebaadcfefeaeaadbdbabf.project.examly.io/order/addToCart", {
